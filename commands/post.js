...
.setTitle("Anything you want to add?")
.setColor("BLUE")
...
.setTitle("What you know to do? ``Script``,``Build``,``GFX``,``GUI Design`` etc")
.setColor("BLUE")
const embed13 = new Discord.RichEmbed()
.setTitle("How much payment? ``<Price>`` - ``Paypal``,``Robux``,``GiftCard`` etc")
.setColor("BLUE")
