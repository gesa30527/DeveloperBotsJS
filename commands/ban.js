...
module.exports.run = async (bot, message, args) => {
    ...
    if(!message.member.roles.find(r => r.name === "Modernators" || r.name === "Founder" || r.name === "Administrator"|| r.name === "Moderator Leader")) return message.reply('You dont have permission to use this command!');
