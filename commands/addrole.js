module.exports.run = async (bot, message, args) => {
    ...
    if(!message.member.roles.find(r => r.name === "Moderators" || r.name === "Founder" || r.name === "Administrator" || r.name === "Moderator Leader" || r.name === "Application Reader" || r.name === "Trial Moderators" )) return message.reply('You dont have permission to use this command!');
