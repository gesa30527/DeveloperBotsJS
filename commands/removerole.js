module.exports.run = async (bot, message, args) => {
    ...
    if(!message.member.roles.find(r => r.name === "Moderators" || r.name === "Founder" || r.name === "Administrator"|| r.name === "Moderator Leader"|| r.name === "Trial Moderators"||r.name === "Application Reader"||r.name === "Trial Application Reader")) return message.reply('You dont have permission to use this command!');
